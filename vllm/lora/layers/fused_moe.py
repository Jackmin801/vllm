...
class FusedMoEWithLoRA(BaseLayerWithLoRA):
    ...
    def set_mapping(self, punica_wrapper):
        ...
        fused_experts = moe_mk.fused_experts
        fused_experts.punica_wrapper = punica_wrapper
        fused_experts.adapter_enabled = self.adapter_enabled
        fused_experts.max_loras = self.max_loras
        fused_experts.w13_slices = self._w13_slices
        fused_experts.fully_sharded = self.fully_sharded
        fused_experts.lora_tp_size = self.tp_size
        fused_experts.lora_tp_rank = self.tp_rank
